...
## 1. History of modeling approaches for the stock
...
Recruitment is determined from the estimated mean recruitment, the yearly recruitment deviations and a gamma function that describes the proportion of recruits by length bin, N~a~ N^a^

$$ N_{t,l} = pr_{l}e^{R_{0}+tao_{t}} $$
